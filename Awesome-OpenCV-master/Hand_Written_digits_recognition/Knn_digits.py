...
digits=cv2.imread("digits.png",cv2.IMREAD_GRAYSCALE) #อ่านรูปเป็น_GRAYSCALE
test_digits=cv2.imread("test_digits.png",cv2.IMREAD_GRAYSCALE)#อ่านรูปเป็น_GRAYSCALE

test_digits=np.vsplit(test_digits,50) # split array

#test digits 
test_cells=[]
for d in test_digits:
    d=d.flatten() #แปลงเป็น array 1D
    test_cells.append(d)
