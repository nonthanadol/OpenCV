...
detector = cv2.CascadeClassifier('haarcascade_fullbody.xml') # ไฟล์ข้อมูลตรวจจับร่างกายที่ train เรียบร้อยแล้ว
img = cv2.imread("sampleBody1.jpg", cv2.IMREAD_COLOR)
